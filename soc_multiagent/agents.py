...
from tools import search_tool, virustotal_checker, gmail_tools, log_notification_to_console
from config import config

# Detectar si Gmail real está disponible
_gmail_available = gmail_tools and gmail_tools[0] is not log_notification_to_console
...
_notification_prompt_suffix = "" if _gmail_available else """

    NOTA: Gmail NO está configurado. Usa la herramienta log_notification_to_console para
    registrar el reporte en consola. Pasa los parámetros: to, subject, message."""
